...
* `SOCI_VISIBILITY` - boolean - Build with C++ visibility if supported. This option produces smaller libraries by trimming internal function symbols. Default is `ON`.
