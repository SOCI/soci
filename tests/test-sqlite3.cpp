...
std::string backEndName = "sqlite3";
...
{
    {
        ...
        catch (SOCIError const &e)
        {
            ...
            assert(msg ==
                "Sqlite3StatementBackEnd::prepare: "
                "no such table: test1_nosuchtable");
        }
...
{
    {
        ...
        std::string str;
        sql << "select \'Hello, Sqlite3!\'", into(str);
        assert(str == "Hello, Sqlite3!");
        ...
        sql << "select datetime(\'2005-11-15 22:14:17\')", into(t);
        assert(t.tm_year == 105);
        assert(t.tm_mon  == 10);
        assert(t.tm_mday == 15);
        assert(t.tm_hour == 22);
...
{
    {
        ...
        // test for char[]
        {
            ...
            char s[] = "Hello";
            sql << "insert into test6(s) values(:s)", use(s);
        ...
        // test for int
        {
            ...
            int i = -12345678;
            sql << "insert into test6(i) values(:i)", use(i);
        ...
        // test for unsigned long
        {
            ...
            sql << "insert into test6(num) values(:ul)", use(ul);
        ...
        // test for double
        {
            ...
            double d = 3.14159265;
            sql << "insert into test6(d) values(:d)", use(d);
        ...
        // test for std::tm
        {
            ...
            t.tm_min = 39;
            t.tm_sec = 57;
            sql << "insert into test6(tm) values(:t)", use(t);
        ...
        // test for repeated use
        {
            ...
            int i;
            Statement st = (sql.prepare
                            << "insert into test6(id) values(:i)", use(i));
...
{
    {
        ...
        sql << "insert into test14(id, img) values(7, '')";
...
{
    {
        ...
        " datetime(\'2005-12-19 22:14:17\'), 'a')";
...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        // !FIXME the following two test require my soci-rowfix.diff patch
//         test17();
//         test18();
