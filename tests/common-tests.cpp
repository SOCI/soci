...
test_context_base* test_context_base::the_test_context_ = nullptr;
...
int main(int argc, char** argv)
{
    ...
    const soci::backend_factory &factory = soci::tests::create_backend_factory();
    std::unique_ptr<soci::tests::test_context_base> ctx = soci::tests::instantiate_test_context(factory, connectString);
