...
macro(soci_backend NAME)
  ...
  if (NOT_FOUND_COUNT GREATER 0)
    ...
    soci_target_output_name(${THIS_BACKEND_TARGET} ${THIS_BACKEND_TARGET_OUTPUT_NAME_VAR})
    set(THIS_BACKEND_TARGET_OUTPUT_NAME ${${THIS_BACKEND_TARGET_OUTPUT_NAME_VAR}})
