...
void test4()
{
    ...
    test_num<double>("12341234123412341234123412341234123412341234123412341",
        true, 1.23412e+52);
// !!! TODO this test don't work on MySQL Server 5.5.25a with C Connector 6.0.2 (MySQL from http://www.mysql.com/downloads/installer/).
...
{
#ifdef SOCI_MYSQL_TEST_CONNSTR
	connectString = SOCI_MYSQL_TEST_CONNSTR;
#else
    if (argc == 2)
    {
