...
{
    {
        ...
        std::string str;
        sql << "select \'Hello, Access!\'", into(str);

        assert(str == "Hello, Access!");
...
{
    {
        ...
        {
            // create and populate the test table
            sql << "create table test3 (sh smallint)";
        ...
        {
            // create and populate the test table
            sql << "create table test3 (ul bigint)";
        ...
        {
            // create and populate the test table
            sql << "create table test3 (d float)";
...
{
    {
        ...
        // test for char
        {
            ...
            char c('a');
            sql << "insert into test6(c) values(?)", use(c);
        ...
        // test for char[]
        {
            ...
            char s[] = "Hello";
            sql << "insert into test6(s) values(?)", use(s);
        ...
        // test for int
        {
            ...
            int i = -12345678;
            sql << "insert into test6(i) values(?)", use(i);
        ...
        {
            sql << "create table test6 (num bigint)";

            unsigned long ul = 4000000000ul;
            sql << "insert into test6(num) values(?)", use(ul);
        ...
        // test for double
        {
            sql << "create table test6 (d float)";

            double d = 3.14159265;
            sql << "insert into test6(d) values(?)", use(d);
        ...
        // test for repeated use
        {
            ...
            int i;
            Statement st = (sql.prepare
                            << "insert into test6(id) values(?)", use(i));
...
{
    {
...

        {
            ...
            sql << "insert into test7(i1, i2, i3) values(:i1, :i2, :i3)",
            ...
            Statement st = (sql.prepare
                << "insert into test7(i1, i2, i3) values(:i1, :i2, :i3)",
                use(i1), use(i2), use(i3));
...
{
    {
        ...
        // test for char
        {
            ...
            sql << "insert into test8(c) values(:v)", use(v);
        ...
        // test for std::string
        {
            ...
            sql << "insert into test8(str) values(:v)", use(v);
        ...
        // test for short
        {
            sql << "create table test8 (sh smallint)";
            ...
            sql << "insert into test8(sh) values(:v)", use(v);
        ...
        // test for int
        {
            ...
            sql << "insert into test8(i) values(:v)", use(v);
        ...
        // test for unsigned long
        {
            sql << "create table test8 (ul bigint)";
            ...
            sql << "insert into test8(ul) values(:v)", use(v);
        ...
        // test for char
        {
            sql << "create table test8 (d float)";
            ...
            sql << "insert into test8(d) values(:v)", use(v);
