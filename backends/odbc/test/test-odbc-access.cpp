...
{
    {
        ...
        {
            // create and populate the test table
            sql << "create table test3 (sh short)";
        ...
        {
            // create and populate the test table
            sql << "create table test3 (ul long)";
...
{
    {
        ...
        // Can't get to work with Access
//         // test for unsigned long
//         {
//             sql << "create table test6 (num long)";
